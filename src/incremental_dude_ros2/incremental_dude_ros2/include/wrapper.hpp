...
public:
	...
	vector<c_polygon*> owned_polygons_;
	//////
	
	std::vector<cv::Point> Parent_contour;
	size_t last_input_contours_{0};
	size_t last_valid_polygons_{0};
	size_t last_rejected_polygons_{0};
	size_t last_cuts_after_resolution_{0};
